...
register_command_handler(handler_more, 'more', ['muc','all'], 0, 'Finishes голование and shows its results.', 'Totals', ['totals'])
register_command_handler(handler_more_control, 'control', ['admin','muc','all'], 20, 'Finishes голование and shows its results.', 'totals', ['totals'])
