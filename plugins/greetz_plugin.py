...
def handler_greet(type,source,parameters):
	...
	if not greet:
		...
		if answ:
			reply(type, source, u'Has killed')
...
register_command_handler(handler_greet, 'greet', ['muc','all'], 20, 'Adds a greeting for certain nick or jid.', 'greet <nick/jid>', ['greet guy=something','greet guy@jabber.aq=anything'])
