...
def handler_botver(type, source, parameters):
        reply(type, source, u'my version is:\nclient: PythonCE\nversion: talisman+neutron 2.5 (rev85) (planb mod)\nos: PocketPc windows mobile©')

register_command_handler(handler_botver, 'botversion', ['info','muc','all'], 0, 'displays the bots version', 'botversion', ['botversion'])
