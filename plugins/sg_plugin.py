...
#	payload=res.getQueryPayload()
	...
	if res.getType()=='error':
		reply(type,source,u'Not destiny :(')
		pass
...
register_command_handler(handler_SG_get, 'stats', ['info','all'], 10, 'Returns statistics about a server XEP-0039.', 'stats <server>', ['stats jabber.aq'])
